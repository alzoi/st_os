...
## Виртуальная память
Программа оперирует виртальными адресами, процессор получает виртуальный адрес, направляет его в устройство MMU и получает соответствующий физический адрес страницы памяти, которая содержит 4КБ данных.
